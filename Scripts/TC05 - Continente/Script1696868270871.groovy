...
WebUI.navigateToUrl('https://www.continente.pt/marcas/produtos-marca-continente/continente-bio/?start=0&srule=Continente&pmin=0.01')
...
WebUI.takeScreenshot('Test/Demo5.png')

WebUI.takeScreenshotAsCheckpoint('Teste5')
